    ...
    <div className='mt-8'>
      ...
      <div className=' bg-accent xl:flex h-80'>
        {AuthorInfo.map((author, index) => (
          <div className={`xl:mt-0 mt-5 xl:w-1/2 p-4 lg:p-0 xl:flex justify-center text-text_white ${index === 0 ? 'block' : 'hidden'}`}>
            ...
            <img src={author.image} alt="" className='rounded-b-full h-96 book hidden lg:block' />
          </div>
        ))}
      </div>
    </div>
